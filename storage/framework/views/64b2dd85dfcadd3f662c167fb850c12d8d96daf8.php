        ...
        <div class="row container">
            ...
            <div class="col-lg-8 col-12">
                ...
                <div class="col-md-12 col-12 mt-3 box-thongbao">
                    <div class="col-12">
                        <form action="<?php echo e(route('returnpass')); ?>" role="form" method="POST">
...
<?php echo $__env->make('layouts.thongtin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webphim\resources\views/user/doimatkhau.blade.php ENDPATH**/ ?>