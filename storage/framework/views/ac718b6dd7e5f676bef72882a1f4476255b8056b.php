                            ...
                            <form class="form form-horizontal" action="<?php echo e(route('tapphim.store')); ?>" method="POST" role="form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" class="form-control" name="episode" placeholder="nhập name tập phim">
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" id="first-name" class="form-control" name="episode_name" placeholder="nhập id tập phim">
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" id="first-name" class="form-control" name="link_nguon" placeholder="nhập link_nguon tập phim">
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/animetvh/domains/animetvh.net/public_html/resources/views/admin/tapphim/create.blade.php ENDPATH**/ ?>