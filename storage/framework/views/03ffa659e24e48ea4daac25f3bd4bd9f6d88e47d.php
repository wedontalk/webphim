    ...
    <div class="header__nav">
        <nav class="header__menu mobile-menu">
            <ul>
                ...
                <li><a href="<?php echo e(url('phim-le/phim-le.html')); ?>">Anime lẻ</a>
                </li>
                <li><a href="<?php echo e(url('phim-bo/phim-bo.html')); ?>">Anime bộ</a>
                </li>
                <li><a href="<?php echo e(url('phim-chieu-rap/phim-chieu-rap.html')); ?>">chiếu rạp</a>
                </li>
            </ul>
        </nav>
    </div>
</div><?php /**PATH /home/animetvh/domains/animetvh.net/public_html/resources/views/user1/menu.blade.php ENDPATH**/ ?>