...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-9 form-group">
                                            <select class="form-select" name="nation_id">
                                                <?php $__currentLoopData = $quocgia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php echo e(($phim->nation_id == $qg->id) ? 'selected':''); ?> value="<?php echo e($qg->id); ?>"><?php echo e($qg->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <!-- Thời lượng phim -->
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" id="first-name" value="<?php echo e($phim->author); ?>" class="form-control" name="author" placeholder="nhập tác giả">
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" id="first-name" value="<?php echo e($phim->status); ?>" class="form-control" name="status" placeholder="nhập trạng thái phim">
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" id="first-name" value="<?php echo e($phim->director); ?>" class="form-control" name="director" placeholder="nhập đạo diễn">
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" id="first-name" value="<?php echo e($phim->actor); ?>" class="form-control" name="actor" placeholder="nhập diễn viên">
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/animetvh/domains/animetvh.net/public_html/resources/views/admin/phim/edit.blade.php ENDPATH**/ ?>