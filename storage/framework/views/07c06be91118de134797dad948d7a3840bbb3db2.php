                ...
                <div class="card">
                    ...
                    <div class="row">
                        <?php $__currentLoopData = $alltapphim; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $all): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span style="width:70px; height:30px"><a href="<?php echo e(route('tapphim.show',$all->id)); ?>" class="badge bg-primary"><?php echo e($all->episode_name); ?></a></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/animetvh/domains/animetvh.net/public_html/resources/views/admin/tapphim/show.blade.php ENDPATH**/ ?>