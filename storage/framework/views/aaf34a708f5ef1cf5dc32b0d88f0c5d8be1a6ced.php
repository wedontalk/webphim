                ...
                <div class="yoast_breadcrumb hidden-xs">
                  <span>
                    <span>
                      ...
                      <?php if(isset($slugtt)): ?>
                      <span class="breadcrumb_last" aria-current="page"><?php echo e($slugtt->name); ?></span>
                      <?php else: ?>
        ...
        <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
          <div class="section-bar is-tabs clearfix">
            <h3 class="section-title">
              <?php if(isset($slugtt)): ?>
              <span><?php echo e($slugtt->name); ?></span>
              <?php else: ?>
              <span>Danh mục</span>
              <?php endif; ?>
            </h3>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\animetvh\resources\views/user/tongdanhmuc.blade.php ENDPATH**/ ?>