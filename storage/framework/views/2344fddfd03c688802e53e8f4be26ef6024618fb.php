                    ...
                    <div class="breadcrumb__links">
                        ...
                        <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $phimtheloai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($pt->id_theloai == $t->id && $pt->id_phim == $phimid->id): ?>
    ...
    <section class="anime-details spad container">
        ...
        <?php $__currentLoopData = $phimtc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phimid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="anime__details__content container">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg" data-setbg="<?php echo e(asset('uploads')); ?>/<?php echo e($phimid->image); ?>">
                ...
                <div class="col-lg-8 col-md-8">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="anime__details__sidebar">
                            ...
                            <div class="product__sidebar__view__item set-bg" data-setbg="<?php echo e(asset('uploads')); ?>/<?php echo e($xn->image); ?>">
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webphim\resources\views/user1/chitiet.blade.php ENDPATH**/ ?>