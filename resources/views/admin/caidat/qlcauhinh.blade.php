                ...
                <div class="row match-height">
                    <div class="col-md-6 col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{route('logoheader')}}" method="post" role="form" enctype="multipart/form-data">
                                        @csrf @method('put')
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <p>logo header hiện tại</p>
                                                    @foreach($data_logo_header as $dt)
                                                        <img src="{{asset('uploads/logo')}}/{{$dt->logo_header}}" alt="" width="100%">
                                                    @endforeach
                                                    <hr>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{route('logofooter')}}" method="post" role="form" enctype="multipart/form-data">
                                        @csrf @method('put')
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    @foreach($data_logo_header as $dt)
                                                        <img src="{{asset('uploads/logo')}}/{{$dt->logo_footer}}" alt="" width="100%">
                                                    @endforeach
                                                    <hr>
                    ...
                    <div class="col-md-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="{{route('thongtinfooter')}}" method="post" role="form" enctype="multipart/form-data">
                                            @csrf @method('PUT')
