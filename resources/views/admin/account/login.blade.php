...
<body>
    <div id="auth">
        <div class="row h-100">
            <!-- <div class="auth-logo">
                <a href="{{route('home.index')}}"><img src="{{asset('wp-content/uploads/logo1-kenhanime.png')}}" alt="Logo" width="100px" height="70px"></a>
            </div> -->
                ...
                <div id="auth-left">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="email" id="email" value="{{ old('email') }}" class="form-control form-control-xl" placeholder="Username">
