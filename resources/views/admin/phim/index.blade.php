                            ...
                            <table class="table table-striped" id="">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{asset('uploads')}}/{{$dt->image}}" alt="" width="100px" height="100px"></td>
                                        <td>{{$dt->name}}</td>
                                        <td class="text-bold-500">{{$dt->slug}}</td>
                                        <td>{{$dt->showphimfirst->max('episode')}}</td>
                                        <td>
                                        ...
                                        <a href="{{route('phim.show',$dt->id)}}" class="btn btn-primary">Xem</a>
