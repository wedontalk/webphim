    ...
    <div class="modal fade in" id="banner_qc" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <a class="click_close" data-href="{{$qc_modal->link}}">
          <div class="modal-body">
              <img src="{{asset('uploads/quangcao')}}/{{$qc_modal->images}}" alt="" width="100%">
          </div>
          </a>
      ...
      <div class="row container">
        <div class="widget about col-xs-12 col-sm-4 col-md-4">
          <div class="footer-logo">
            <img class="img-responsive" src="<?php foreach($showcauhinh as $key => $avatar) {echo'../../uploads/logo/'.$avatar->logo_footer;} ?>" alt="{{$avatar->logo_footer}}" width="420px" height="200px"/>
